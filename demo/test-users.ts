...
export const nameAlice = "Amr";
export const uriAlice = "sip:amr" + token + "@" + domain;
export const webSocketServerAlice = "wss://edge.sip.onsip.com";

export const nameBob = "Badran";
export const uriBob = "sip:amrhoballah@hoballah1.onsip.com";
